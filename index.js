...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = hotelsCopy.sort(sortByPricing, pricing);
  res.json({ hotels: result });
});

//have a doubt

function sortByRating(stock1, stock2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let result = hotelsCopy.sort(sortByRating, rating);
  res.json({ hotels: result });
});

//have a doubt
function sortByReviews(stock1, stock2, reviews) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let result = hotelsCopy.sort(sortByReviews, reviews);
  res.json({ hotels: result });
});

//filter the hotel by their amenity
